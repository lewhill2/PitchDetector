...
- (void) completeRecordingSession {
    ...
    @synchronized(self) {
        ...
        [videoWriter finishWritingWithCompletionHandler:^{
            success = videoWriter.status == AVAssetWriterStatusCompleted;
        ...
        if (success){
            UISaveVideoAtPathToSavedPhotosAlbum(outputPath, self, @selector(video:didFinishSavingWithError: contextInfo:), outputPath);
        }
        [outputPath release];
        [outputURL release];
        }];
...
- (void)video:(NSString *)videoPath didFinishSavingWithError:(NSError *)error contextInfo:(void *)contextInfo {
    if (error != nil) {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Movie Saved" message:@"Movie has been saved in your photo album." delegate:nil cancelButtonTitle:@"Dismiss" otherButtonTitles:nil];
